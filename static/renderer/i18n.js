...
const translations = {
  fr: {
    ...
    "selected.arena.title": "Arena",
    "selected.arena.general": "Général",
    "selected.arena.collapse": "Replier la section Arena",
    "selected.arena.expand": "Deplier la section Arena",
    "selected.arena.noneActive": "Aucun changement Arena actif.",
    "selected.arena.none": "Aucun changement Arena.",
  ...
  en: {
    ...
    "selected.arena.title": "Arena",
    "selected.arena.general": "General",
    "selected.arena.collapse": "Collapse Arena section",
    "selected.arena.expand": "Expand Arena section",
    "selected.arena.noneActive": "No active Arena changes.",
    "selected.arena.none": "No Arena changes.",
